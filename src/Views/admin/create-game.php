    ...
    <div class="mb-8">
        ...
        <div class="mt-6 flex items-center gap-4">
            ...
            <div>
                ...
                <h1 class="text-3xl font-black uppercase">Ajouter un match</h1>
            </div>
        </div>
    </div>

    <form action="/admin/games/create" method="POST" class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="player_id" required class="bg-gray-900 border border-gray-700 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition">
                        ...
                        <?php foreach ($players as $player): ?>
                            <option value="<?= $player['id'] ?>"><?= htmlspecialchars($player['first_name']) ?> <?= htmlspecialchars($player['last_name']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="flex flex-col gap-2">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="flex flex-col gap-2">
                    ...
                    <input type="number" name="score_team" min="0" required
                        class="bg-gray-900 border border-gray-700 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition">
                </div>
                <div class="flex flex-col gap-2">
                    <label class="text-gray-400 text-xs uppercase tracking-widest">Score extérieur</label>
                    <input type="number" name="score_opponent" min="0" required
                        class="bg-gray-900 border border-gray-700 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-4 gap-6">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="number" name="minute_played" min="0" max="48" required
                        class="bg-gray-900 border border-gray-700 text-white px-4 py-3 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition">
                </div>
            </div>
        </div>
